...
import { ArrowLeft, Construction, Code2, Zap } from 'lucide-react';
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-8 max-w-md mx-auto">
              ...
              {!subscribed ? (
                <form onSubmit={handleSubscribe} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full px-6 py-3 bg-black dark:bg-white text-white dark:text-black font-medium rounded-md hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors"
                  >
                    Notify Me
                  </button>
                </form>
